...
if __name__ == "__main__":
    ...
    # # save UserManager, ArtistManager, TrainUserManager
    # save(UserManager, 'user-manager.pkr')
    # save(ArtistManager, 'artist-manager.pkr')
    # save(TrainUserManager, 'train-user-manager.pkr')

    # load UserManager, ArtistManager, TrainUserManager
    starttime = time.time()
    UserManager = load('user-manager.pkr')
    ArtistManager = load('artist-manager.pkr')
    TrainUserManager = load('train-user-manager.pkr')
    endtime = time.time()
